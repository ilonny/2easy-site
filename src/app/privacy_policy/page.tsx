        ...
        <>
          ...
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              ...
              агрегаторы: CloudPayments, Patdy);
            </span>
          </p>
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
          ...
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              ...
              cookie и технические данные, с использованием инструментов
          ...
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              ...
              оформлении Подписки через сайт Оператора, а также при обращении
              через мессенджеры или электронную почту. Передача персональных
              данных означает согласие Пользователя с настоящей Политикой. Под
              согласием на обработку персональных данных также понимаются
              действия Пользователя, выражающие намерение воспользоваться
              услугами Оператора, включая оформление и оплату Подписки, отправку
          ...
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              ...
              хранятся в автоматизированных системах, используемых Оператором, а
              также в системах платёжных агрегаторов (CloudPayments, Patdy) и в
              облачных сервисах, применяемых для ведения переписки и обработки
              запросов (включая электронную почту и мессенджеры). Хранение
              персональных данных осуществляется до момента отзыва согласия
