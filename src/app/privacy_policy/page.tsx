        ...
        <>
          ...
          >
            ...
            >
              ...
              по обеспечению их безопасности, принимаемые индивидуальным
              предпринимателем Лобасенко Екатериной Борисовной (ИНН:
              420553023451, ОГРНИП: 324547600006209), далее — Оператор.
            </span>
          </p>
          <p
            className="ConsPlusNonformat"
          ...
          >
            ...
            >
              ...
              свобод человека и гражданина при обработке персональных данных,
              включая защиту права на неприкосновенность частной жизни, личную и
              семейную тайну.
            </span>
          </p>
          <p
          ...
          >
            ...
            >
              ...
              Оператор может получить от пользователей в процессе предоставления
              доступа к цифровым материалам по подписке, а также при
              использовании сайта https://www.2easyeng.com, оформлении подписки,
              оплате услуг, обращении через электронную почту, мессенджеры или
              иные каналы связи.
            </span>
          </p>
          <p
          ...
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              ...
              их доступность в сети Интернет по адресу:{" "}
          ...
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              ...
              средств автоматизации или без таковых с персональными данными,
          ...
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              2.7. Оператор — индивидуальный предприниматель Лобасенко Екатерина
              Борисовна (ИНН: 420553023451, ОГРНИП: 324547600006209),
              самостоятельно осуществляющий обработку персональных данных, а
              также определяющий цели обработки, состав обрабатываемых данных и
              совершаемые действия с персональными данными.
            </span>
          </p>
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              2.8. Персональные данные — любая информация, относящаяся прямо или
              косвенно к определённому или определяемому Пользователю сайта
          ...
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              ...
              https://www.2easyeng.com и/или оформляющее подписку на услуги,
              предоставляемые Оператором.
            </span>
          </p>
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
          ...
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              ...
              кругу лиц или предоставление доступа к ним неограниченному кругу
              лиц.
            </span>
          </p>
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              ...
              иностранным субъектам (физическим или юридическим лицам, органам
              власти).
            </span>
          </p>
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              2.14. Уничтожение персональных данных — действия, в результате
              которых персональные данные безвозвратно уничтожаются с
              невозможностью последующего восстановления либо уничтожаются их
          ...
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">3.1. Оператор имеет право:</span>
          </p>
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
          ...
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              ...
              обработку — продолжить обработку без согласия при наличии
              оснований, предусмотренных Законом о персональных данных;
            </span>
          </p>
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              ...
              предусмотренных Законом о персональных данных и иными нормативными
              правовыми актами, если иное не установлено законом.
            </span>
          </p>
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">3.2. Оператор обязан:</span>
          </p>
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              – по запросу субъекта персональных данных предоставлять
          ...
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              ...
              или их представителей в установленный законом срок;
            </span>
          </p>
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              – по запросу уполномоченного органа по защите прав субъектов
              персональных данных предоставлять запрашиваемую информацию в
              течение 30 календарных дней с даты получения запроса;
            </span>
          </p>
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              – публиковать или иным способом обеспечивать неограниченный доступ
          ...
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              – прекратить передачу (распространение, предоставление, доступ), а
              также прекратить обработку и уничтожить персональные данные в
          ...
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              ...
              данных, за исключением случаев, предусмотренных федеральным
              законодательством. Сведения предоставляются Оператором в доступной
              форме, без включения персональных данных иных субъектов, за
          ...
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              ...
              своих персональных данных в случаях, если данные являются
          ...
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              – устанавливать предварительное согласие на обработку персональных
              данных в целях продвижения товаров, работ и услуг на рынке;
            </span>
          </p>
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              – отозвать согласие на обработку персональных данных в любое
              время;
            </span>
          </p>
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              – обжаловать действия или бездействие Оператора, нарушающие его
              права, в уполномоченный орган по защите прав субъектов
          ...
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">4.2. Субъекты персональных данных обязаны:</span>
          </p>
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
          ...
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              – своевременно информировать Оператора об изменении, обновлении
              или уточнении своих персональных данных.
            </span>
          </p>
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              4.3. Лица, передавшие Оператору недостоверные сведения о себе,
              либо сведения о других лицах без соответствующего на то основания
              (в том числе без согласия субъекта персональных данных), несут
          ...
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              ...
              предоставленные Пользователем в рамках бронирования и получения
              услуг:
            </span>
          </p>
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">5.1.1. Фамилия, имя, отчество;</span>
          </p>
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">5.1.2. Адрес электронной почты;</span>
          </p>
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">5.1.3. Номер телефона;</span>
          </p>
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              5.1.4. Платёжные данные (в обезличенном виде, через платёжные
              агрегаторы: CloudPayments, ЮKassa, Robokassa);
            </span>
          </p>
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              5.1.5. Иные сведения, которые Пользователь добровольно указывает
              при заполнении форм на Сайте или при общении с Оператором.
            </span>
          </p>
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              5.2. Также может осуществляться сбор и обработка обезличенных
              данных о посетителях сайта https://www.2easyeng.com, включая файлы
              cookie и технические данные, с использованием встроенных
              инструментов аналитики платформы Tilda, с использованием
              инструментов интернет-аналитики, таких как Яндекс.Метрика или
              аналогичные сервисы.
            </span>
          </p>
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              5.3. Перечисленные в настоящем разделе сведения далее по тексту
              Политики именуются «персональными данными».
            </span>
          </p>
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              5.4. Оператор не осуществляет обработку специальных категорий
              персональных данных, касающихся расовой или национальной
              принадлежности, политических взглядов, религиозных или философских
              убеждений, состояния здоровья или интимной жизни.
            </span>
          </p>
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              ...
              исключительно при соблюдении условий и ограничений, установленных
              статьёй 10.1 Закона о персональных данных.
            </span>
          </p>
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              5.6. Согласие Пользователя на обработку персональных данных,
              разрешённых для распространения, оформляется отдельно и должно
              соответствовать требованиям, установленным уполномоченным органом
          ...
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              ...
              получения согласия опубликовать информацию об условиях обработки и
              наличии ограничений, предусмотренных законом.
            </span>
          </p>
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              5.6.3. Пользователь вправе в любое время отозвать согласие на
              распространение персональных данных, направив письменное
              требование с указанием своих ФИО, контактной информации и перечня
              подлежащих прекращению обработке данных.
            </span>
          </p>
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              5.6.4. Согласие на обработку персональных данных, разрешённых для
              распространения, прекращает своё действие с момента поступления
              Оператору указанного требования.
            </span>
          </p>
          <p
            className="ConsPlusNormal"
          ...
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              – оформление и сопровождение Подписки на цифровые образовательные
              материалы, предоставляемые Оператором;
            </span>
          </p>
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              – обработка запросов, обращений и сообщений, поступающих через
              сайт и мессенджеры;
            </span>
          </p>
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              – предоставление технической поддержки и обратной связи, включая
              восстановление доступа и ответы на вопросы Пользователей;
            </span>
          </p>
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              – направление информационных и рекламных сообщений по согласованию
              с Пользователем (в том числе через email и мессенджеры);
            </span>
          </p>
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              – ведение внутреннего учёта, статистики, а также выполнение
              требований законодательства Российской Федерации, включая
              налоговый и бухгалтерский учёт.
            </span>
          </p>
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              7.2. Оператор вправе направлять Пользователю информационные и
              рекламные сообщения о новых услугах, специальных предложениях,
              акциях и мероприятиях. Пользователь вправе в любое время
              отказаться от получения указанных сообщений, направив
              соответствующее уведомление на электронную почту Оператора:
              tatianaanenko@gmail.com с пометкой «Отказ от информационных
              сообщений».
            </span>
          </p>
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              7.3. Обезличенные данные, собираемые с использованием сервисов
              интернет-статистики, используются для анализа поведения
              Пользователей, улучшения структуры и содержания сайта, а также
          ...
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              – положения Федерального закона от 27.07.2006 № 152-ФЗ «О
              персональных данных» и других нормативно-правовых актов в сфере
              защиты персональных данных;
            </span>
          </p>
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              – договоры, заключённые между Оператором и субъектом персональных
              данных, включая договор на основании акцепта публичной оферты;
            </span>
          </p>
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              – добровольно предоставленные субъектом согласия на обработку
              персональных данных (в том числе при обращении через агрегаторы,
              по e-mail, телефону, мессенджерам).
            </span>
          </p>
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              ...
              электронную почту. Передача персональных данных означает согласие
              Пользователя с настоящей Политикой. Под согласием на обработку
              персональных данных также понимаются действия Пользователя,
              выражающие намерение воспользоваться услугами Оператора, включая
              оформление и оплату Подписки, отправку сообщений, заполнение форм
              или иные активные действия.
            </span>
          </p>
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              ...
              обрабатываются в случае, если это разрешено в настройках браузера
              Пользователя.
            </span>
          </p>
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              8.4. Субъект персональных данных самостоятельно и добровольно
              принимает решение о предоставлении своих персональных данных
              Оператору, выражая при этом согласие на их обработку в своих
              интересах.
            </span>
          </p>
          <p
          ...
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              ...
              принимает все возможные меры, направленные на предотвращение
              доступа к персональным данным со стороны неуполномоченных лиц.
            </span>
          </p>
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
          ...
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              – передача необходима для исполнения обязательств Оператора перед
              Заказчиком в рамках заключённого договора (в том числе при
              бронировании через сторонние платформы).
            </span>
          </p>
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              10.3. В случае выявления неточностей в персональных данных,
              Пользователь вправе актуализировать их, направив соответствующее
              уведомление на электронную почту Оператора: lobasenko1994@mail.ru
              с пометкой «Актуализация персональных данных».
            </span>
          </p>
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              10.4. Срок обработки персональных данных определяется целями, в
              которых такие данные были получены, если иное не установлено
              договором, законодательством Российской Федерации или иными
              обязательными требованиями. Пользователь вправе в любой момент
              отозвать согласие на обработку персональных данных, направив
              уведомление на адрес: lobasenko1994@mail.ru с пометкой «Отзыв
          ...
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              ...
              позволяющей определить субъекта персональных данных, не дольше,
              чем этого требуют цели обработки, если иной срок хранения не
              установлен федеральным законом или договором. Персональные данные
              хранятся в автоматизированных системах, используемых Оператором,
              включая платформу Tilda, а также в системах платёжных агрегаторов
              (CloudPayments, ЮKassa, Robokassa) и в облачных сервисах,
              применяемых для ведения переписки и обработки запросов (включая
              электронную почту и мессенджеры). Хранение персональных данных
              осуществляется до момента отзыва согласия Пользователя, если иное
          ...
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              10.10. Безопасность персональных данных, которые обрабатываются
          ...
          <p align="center" style={{ textAlign: "center" }}>
            <span lang="RU">13. Конфиденциальность персональных данных</span>
          </p>
          <p>
            <span lang="RU">
          ...
          <p align="center" style={{ textAlign: "center" }}>
            <span lang="RU">14. Заключительные положения</span>
          </p>
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              14.1. Пользователь вправе получить разъяснения по вопросам,
              касающимся обработки его персональных данных, направив запрос на
              электронную почту Оператора: lobasenko1994@mail.ru.
            </span>
          </p>
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              14.2. Настоящая Политика может быть изменена Оператором в любое
              время. Все изменения вступают в силу с момента размещения новой
              редакции Политики, если иное не предусмотрено самой Политикой.
              Политика действует бессрочно до момента её замены новой версией.
            </span>
          </p>
          <p style={{ textAlign: "justify" }}>
            <span lang="RU">
              14.3. Актуальная версия Политики в свободном доступе размещается
              на официальном сайте Оператора: https://www.2easyeng.com.
            </span>
          </p>
          <br />
          <br />
