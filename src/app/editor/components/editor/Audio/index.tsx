...
export const Audio: FC<TProps> = ({
  ...
  return (
    <div>
      ...
      <p>
        <T
          k="editor.audioFileHint"
          defaultText="Аудиофайл (не более 10 мб, поддерживаемые форматы: .mp3, .wav, .m4a)"
        />
      </p>
      <Button
        ...
        if (err.reason === "FILE_SIZE_TOO_LARGE") {
          return (
            <p key={err.reason} className="text-danger">
              <T k="editor.fileTooLarge" defaultText="Файл слишком большой" />
            </p>
          );
        }
      })}
      <div className="w-[100%] mb-4">
        <TitleExInput
          label={<T k="common.title" defaultText="Название" />}
      ...
      <TitleExInput
        isTextarea
        label={<T k="editor.audioScript" defaultText="Скрипт" />}
