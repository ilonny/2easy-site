...
export const speakingGames: TCard[] = [
  {
    ...
    description:
      "захватывающая игра на отгадывание слов, в которой игроки должны описать слово, не используя список «табуированных слов», который указан на карточке",
    link: "/speaking_games/taboo",
    videoSrc: "",
  },
  {
    title: "Never have I ever",
    subTitle: "130+ cards, A2 -- C1",
    description:
      "идеальная игра для практики Present Perfect. 80 карточек с высказываниями, которые легко использовать в последние минуты занятия или включить в урок, как полноценную активность",
    link: "/speaking_games/never_have_i_ever",
    videoSrc: "",
  },
  {
    title: "Would you rather",
    subTitle: "50+ cards, A1+",
    description:
  ...
  },
  {
    ...
    subTitle: "30 short videos, A2 -- C1",
    description:
...
export const discussionCards: TCard[] = [
  {
    ...
    subTitle: "140+ cards, B1+",
    description:
      "Более 140 нетривиальных вопросов на разные жизненные темы — от еды до феминизма и бизнеса. Подходит для студентов уровня B1 и выше",
  ...
  },
  {
    ...
    subTitle: "30 cards, A2+",
    description:
      "карточки с Противоречивыми утверждениями на разные темы, помогающее научить студента отстаивать свое мнение на английском",
