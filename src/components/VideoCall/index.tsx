...
export const VideoCall: FC<TProps> = ({ lessonId }) => {
  ...
  useEffect(() => {
    ...
    loadScript()
      ...
      .catch(() => {
        toast.error(i18n.t("videoCall.loadError"));
        setIsOpen(false);
      });
  }, [isOpen, loadScript]);
